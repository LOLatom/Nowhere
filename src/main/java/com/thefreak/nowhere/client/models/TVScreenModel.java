...
public class CustomModel<T extends Entity> extends EntityModel<T> {
	...
	private final ModelPart ScreenCap;

	public CustomModel(ModelPart root) {
		this.Main = root.getChild("Main");
		this.ScreenCap = root.getChild("ScreenCap");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition ScreenCap = Main.addOrReplaceChild("ScreenCap", CubeListBuilder.create().texOffs(0, 44).addBox(-8.0F, -6.5F, -1.5F, 16.0F, 13.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.0F, -9.5F, -6.0F, 0.0873F, 0.0F, 0.0F));
